					...
					<div class="youzify-course-inner-content">
						...
						<div class="youzify-course-completion-data">
							...
							<div class="youzify-course-completion-meta">
								...
								<div class="youzify-course-bar-percent"><?php /* translators: %d: completion percentage */ echo sprintf( __( '<span class="youzify-course-meta-label">Completed:</span> <span class="youzify-course-meta-value">%d%%</span>', 'youzify' ), $progress['percent'] ) ?></div>
								<?php endif; ?>

								<?php if ( $display_completion_steps == 'on' ) : ?>
								<span class="youzify-course-progress-steps"><?php /* translators: %s: completed/total lessons count */ echo sprintf( __( '<span class="youzify-course-meta-label">Lessons:</span> <span class="youzify-course-meta-value">%s</span>', 'youzify' ), $progress['completed']. '/' . $progress['total'] ); ?>
								</span>
								<?php endif; ?>
